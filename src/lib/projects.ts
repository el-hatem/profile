...
export const projects: Project[] = [
  { 
    ...
    techTags: ["Python", "FastAPI", "MongoDB", "JWT", "OTP", "Urway", "Docker", "GCP Cloud Run"],
    metric: "-30% latency",
    ...
    patterns: ["Multi-Tenancy", "Cache-Aside", "Repository", "Idempotency", "Blue-Green Deployment"],
    results: [
    { label: "Latency", value: "-30%" },
    { label: "Orders/day", value: "10k+" },
    { label: "Payments", value: "Fewer failures" },
    { label: "Tenancy", value: "Safer" },
    ],
  ...
  { 
    ...
    techTags: ["Python", "Django", "PostgreSQL", "Redis", "Stripe", "HyperPay", "AES", "Docker", "Pytest"],
    metric: "-40% incidents",
    ...
    patterns: ["Transactional Consistency", "Idempotency", "Cache-Aside", "Defense in Depth", "Test-Gated CI/CD"],
    results: [
    { label: "Incidents", value: "-40%" },
    { label: "Users", value: "50k+" },
    { label: "Security", value: "Stronger" },
    { label: "Payments", value: "More reliable" },
    ],
  ...
  { 
    ...
    techTags: ["Python", "Django", "FastAPI", "Celery", "Redis", "Docker", "JWT", "PostGIS", "LLM APIs"],
    metric: "Lower latency",
    demoUrl: "https://play.google.com/store/apps/details?id=com.wazen.health.wazen_app",
    repoUrl: "",
    problem:
    "Wazen delivered nutrition recommendations to consumers and had to process uploaded meals, documents, recommendation generation, and analytics in Arabic-first user flows. AI-heavy operations such as LLM calls, nutrition calculations, and report generation were initially synchronous, which increased latency on user-facing recommendation paths and created reliability issues through silent failures, inconsistent response structure, and hallucination-prone outputs.",
    solution:
    ...
    patterns: ["Hybrid Architecture", "Async Processing", "Work Queue", "Observability", "Fault Isolation", "Structured Prompting"],
    results: [
      { label: "Latency", value: "-30%" },
      { label: "Processing", value: "Async" },
      { label: "Quality", value: "Arabic-first" },
      { label: "Reliability", value: "More stable" },
    ],
  ...
  { 
    ...
    techTags: ["Python", "Django", "PostgreSQL", "Redis", "WebSockets", "Celery", "FFmpeg", "Docker", "FCM"],
    metric: "Spike-ready",
    demoUrl: "",
    repoUrl: "",
    problem:
    "Talk combined live feed activity, media sharing, and community interactions in a multilingual product where delivery latency and connection stability mattered. Real-time fanout, feed load, and CPU-heavy audio and video transcoding competed for the same backend capacity, which risked slowing user interactions, blocking request handling, and degrading the experience during peak activity.",
    solution:
    ...
    patterns: ["Pub/Sub", "Async Worker Pipeline", "Real-Time Messaging", "Workload Isolation", "Event-Driven Processing", "Observability"],
    results: [
    { label: "Messaging", value: "1s class" },
    { label: "Media", value: "Async" },
    { label: "Load", value: "Spike-safe" },
    { label: "Engagement", value: "+replies" }
    ],
  ...
  },
  {
    ...
    patterns: ["Pipeline Standardization", "Normalization", "Internationalization", "Workflow Automation", "Schema Standardization"],
    results: [
      { label: "Accuracy", value: "+25%" },
      { label: "Languages", value: "AR/EN/FR" },
      { label: "Review", value: "Reduced" },
      { label: "Outputs", value: "Standardized" },
    ],
  ...
  },
  {
    ...
    patterns: ["Workflow Engine", "Async Batch Processing", "ETL Pipeline", "Operational Reporting", "Lifecycle Management"],
    results: [
      { label: "Workflows", value: "Async" },
      { label: "Reporting", value: "Multi-format" },
      { label: "Coverage", value: "Web + Mobile" },
      { label: "Control", value: "Lifecycle-tracked" },
    ],
